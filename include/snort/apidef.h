...
/*
  ...
  @code
    ...
    __SNORT_DECLSPEC__ int my_function(void);
  ...
  @endcode
*/
#if defined(__SNORT_SHARED__) && defined(_MSC_VER)
#  ifdef __SNORT_EXPORT__
#    define __SNORT_DECLSPEC__ __declspec (dllexport)
#  else
#    define __SNORT_DECLSPEC__ __declspec (dllimport)
#  endif
#else
#  define __SNORT_DECLSPEC__
#endif
...
/*
  ...
  @code
    // In C++ code:
    __SNORT_EXTERN__ int my_function(void);
...
*/
#ifdef __cplusplus
#  define __SNORT_EXTERN__ extern "C"
#else
#  define __SNORT_EXTERN__ extern
#endif
...
/*
  ...
  @code
    ...
    __SNORT_API__ int snort_init(void);
    __SNORT_API__ int snort_process_data(const void* data, size_t size);
  ...
  @see __SNORT_DECLSPEC__ for export/import details
  @see __SNORT_EXTERN__ for C++ linkage details
*/
#define __SNORT_API__ __SNORT_DECLSPEC__ __SNORT_EXTERN__
